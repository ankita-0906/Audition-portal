...
function Ninth({ formData, handleInputChange, setpage }) {
  return (
    <div>
      <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
        ...
        <form className="bg-transparent p-8 rounded-lg shadow-lg w-[800px] transition-transform transform hover:scale-105 z-10 text-cyan-200 block">
          <h2 className="text-2xl font-bold text-center mb-6">Q5. What kind of events/workshops/webinars would you like us to organize? Do you think it will be beneficial for the club and why?</h2>
          <textarea
            name="answer_fifth"
            value={formData.answer_fifth}
